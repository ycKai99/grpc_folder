...
import { LogSetting, MessageLog } from "../type/datatype";
...
let sampleStreamMessages: Observable<MessageLog> = new Observable(
    (subscriber) => {
...
try {
    ...
    /* UltraStreamTest: Test for using more data with longer intervals. With also passng url as connection string rather than passing credentials*/
