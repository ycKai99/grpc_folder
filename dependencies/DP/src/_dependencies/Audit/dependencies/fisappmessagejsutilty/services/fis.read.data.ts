...
import { DataTypeFormat } from '../dependencies/dependencies';
export class DataTypeProfile {
  name: string;
}
export class MessageTypeProfile {
  name: AppMessageType;
}

export class FisReadDataUtility {
  /**
  ...
  readDataType(
    ...
    response: ResponseMessage | NotificationMessage,
    messageType: MessageTypeProfile,
    dataType: DataTypeProfile,
  ): object {
    try {
      let data: object = {};
      let message: RequestMessage | NotificationMessage | ResponseMessage;
