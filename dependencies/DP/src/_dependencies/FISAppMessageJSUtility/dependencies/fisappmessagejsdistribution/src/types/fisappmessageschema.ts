 ...
 */
export type MessageProducerInformation =
 ...
 */
export type UserInterfaceControlPanelFunctionsEnum = UserInterfaceControlCommonFunctions &
  UserInterfaceControlPanelFunctions & {
    [k: string]: unknown;
  };
/**
 ...
 */
export type UserInterfaceControlCommandFunctionsEnum = UserInterfaceControlCommonFunctions &
  UserInterfaceControlCommandFunctions;
/**
 ...
 */
export type UserInterfaceControlFieldFunctionsEnum = UserInterfaceControlCommonFunctions &
  UserInterfaceControlFieldFunctions;
 ...
 */
export enum AppArchitectureTiers {
 ...
 */
export enum UserInterfaceComponentTypes {
 ...
 */
export enum FisAppServerComponents {
 ...
 */
export enum UserInterfaceControlTypes {
  Panel = "Panel",
  Command = "Command",
  Field = "Field"
}
 ...
 */
export enum UserInterfaceControlCommonFunctions {
  Enable = "Enable",
  Disable = "Disable",
  Hide = "Hide",
  Unhide = "Unhide",
 ...
 */
export enum UserInterfaceControlPanelFunctions {
  Open = "OPEN",
  Close = "CLOSE",
  ScrollUp = "SCROLL-UP",
...
export enum UserInterfaceControlCommandFunctions {
  Execute = "EXECUTE",
...
export enum UserInterfaceControlFieldFunctions {
