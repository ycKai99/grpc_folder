...
const source_payload = stream.stream().pipe(rxjs_1.take(4));
...
const target_payload = stream.stream().pipe(rxjs_1.take(2));
...
let settings = {
    ...
    target: Object.assign(Object.assign({}, target_storage), { tags: ['Incoming'] }) //LogSetting & {tags:string[] }  
};
/* -------- SYNCHRONIZATION --------- */
