...
class FisCreateMessageUtility {
    constructor(UserAppId, UserAppName = '', producer = dependencies_1.ProducerType.UI) {
        this.thisUserAppId = '';
        this.requesterID = 'ObserverModule-' + new Date().getUTCMinutes();
        this.PRODUCER = {
        ...
        this.setUserAppSettings(UserAppId, UserAppName, producer);
    }
    getApplicationId() {
    ...
    getLoginMessage() {
        let messageParm = {
            ...
            data: {
                ...
                timeout: environment_1.process.env.loginTimeoutMinutes || 24 * 60,
            },
