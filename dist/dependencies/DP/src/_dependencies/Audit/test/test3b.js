...
const source_payload = stream.stream().pipe((0, rxjs_1.take)(2));
...
const target_payload = stream.stream().pipe((0, rxjs_1.take)(4));
...
let settings = {
    ...
    target: Object.assign(Object.assign({}, source_storage), { tags: ['Incoming'] })
};
